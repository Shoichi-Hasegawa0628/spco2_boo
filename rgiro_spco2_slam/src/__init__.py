...
alpha0 = 12 # 0.2 #0.1
gamma0 = 0.1 # 0.08      #Hyperparameter of CRP in multinomial distribution for index of position distribution
...
# task1
# object_dictionary = ["blue water bottle", "cup", "apple"]

# task2
object_dictionary = ["yellow backpack", "sanack box", "apple"]


# # floor1
# object_dictionary = ["penguin_doll", "sheep_doll", "pudding_box", "fruits_juice", "tooth_paste", "apple", "orange", "muscat", "plate", "bowl", "pitcher_base", "towel", "coffee"]

# floor2
# object_dictionary = ["banana", "cracker_box", "chips_bag", "pig_doll", "airplane_toy", "car_toy", "truck_toy", "cup", "treatments", "sponge", "bath_slipper"]
