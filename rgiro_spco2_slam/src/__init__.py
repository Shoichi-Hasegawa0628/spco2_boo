...
alpha0 = 3.0 # 30
gamma0 = 0.03 # 0.1      #Hyperparameter of CRP in multinomial distribution for index of position distribution
beta0 = 0.01 # 0.1          #Hyperparameter in multinomial distribution P(W) for place names
